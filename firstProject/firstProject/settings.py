...
DEFAULT_FROM_EMAIL = 'bemyself.keita.2015@gmail.com'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'smtp.gmail.com'            # GmailのSMPTサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = 'bemyself.keita.2015@gmail.com'     # Gmailのアドレスを入力
EMAIL_HOST_PASSWORD = 'qlhvojsrsrrolwcd' # Gmailのアプリ用パスワードを入力
